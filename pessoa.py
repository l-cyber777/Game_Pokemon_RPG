...
NOMES = [
    "Lourenço", "Isabela", "Caique", "Kelly", "Paulo", "Shirley", 
    "Wellington", "Luisa", "Luana", "Luly", "July"
]

POKEMONS = [
    PokemonFogo("Charmander"),
    PokemonFogo("Flarion"),
    PokemonEletrico("Charmilion"),
    ...
    def batalhar(self, pessoa):
        ...
        if pokemon and pokemon_inimigo:
            while True:
                ...
                if pokemon.vida <= 0:
                    print("{} perdeu a batalaha".format(self))
...
class Inimigo(Pessoa):
    ...
    def __init__(self, nome=None, pokemons=None):
        if not pokemons:
            pokemons_aleatorios = []
            for indice in range(random.randint(1,6)):
